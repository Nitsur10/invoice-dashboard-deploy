...
_Last updated: 9/30/2025, 11:22:24 PM (execution: 2s)_

**At a glance**
- **Repos**: 1 (1 success, 0 failed)
- **Open PRs**: 5 | Ready: 0 | Needs review: 4 | Failing: 1 | Blocked: 0 | Draft: 0 | Stale: 0
- **Open Issues**: 6 | Features: 0 | Bugs: 1 | Stale: 0

**Health Status**: 🟡 4 API failures | Rate limit: 4959 remaining
<!-- tracker:summary:end -->
...
|:-:|:---:|:----:|:-----:|:------:|
| [#19](https://github.com/Nitsur10/invoice-dashboard-deploy/pull/19) | invoice-dashboard-deploy | fix: Invoice summary cards show database totals no... | Nitsur10 | 9/30/2025 |
...
---
_Generated by Portfolio Control Board v1.0 • Execution time: 2s • API calls: 21 (4 failed)_
