...
_Last updated: 10/6/2025, 4:37:37 AM (execution: 2s)_

**At a glance**
- **Repos**: 1 (1 success, 0 failed)
- **Open PRs**: 5 | Ready: 0 | Needs review: 2 | Failing: 2 | Blocked: 0 | Draft: 0 | Stale: 0
- **Open Issues**: 6 | Features: 0 | Bugs: 1 | Stale: 0

**Health Status**: 🟡 5 API failures | Rate limit: 4979 remaining
<!-- tracker:summary:end -->
...
```mermaid
graph LR
    A[Total PRs: 5] --> B{Readiness Score}
...
---
_Generated by Portfolio Control Board v1.0 • Execution time: 2s • API calls: 22 (5 failed)_
